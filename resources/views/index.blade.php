            ...
            <ul class="card-list swiper-wrapper">
                ...
                <li class="card-item swiper-slide">
                    <div href="#" class="card-link">
                        <img src="img/room.jpeg" alt="Card Image" class="card-image">
                        ...
                        <div class="card-button">
                            ...
                            <div class="dropdown">
                                <button class="book-now" id="bookBtn">Book Now ▾</button>
                                <div class="dropdown-content" id="dropdownMenu">
                                    <a href="JENARJUJUCOOR.blade.php">Corporate Booking Form</a>
                                    <a href="JENARJUJUPERSONAL.blade.php">Personal Booking Form</a>
                                </div>
                        </div>
                    </div>
                </li>
